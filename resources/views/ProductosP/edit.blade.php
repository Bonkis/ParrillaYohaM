...
@section('content')
    <div class="card">
        ...
        <div class="card-body">
            ...
            {!! Form::model($productoP,['route' => ['ProductosPActualizar',$productoP],'method'=>'put']) !!}
            ...
            {!! Form::submit('Actualizar Producto', ['class'=> 'btn btn-danger -btn-sm']) !!}
            {!! Form::close() !!}
        </div>
